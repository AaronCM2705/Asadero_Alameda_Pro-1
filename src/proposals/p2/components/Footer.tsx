      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-on-surface text-sm leading-relaxed mb-8 font-bold">
          ...
          {/* Links */}
          <div>
            <h4 className="font-headline font-black text-sm uppercase tracking-widest mb-8 text-on-surface">Navegación</h4>
            <ul className="space-y-4 text-sm font-black text-on-surface">
          ...
          {/* Contact */}
          <div>
            <h4 className="font-headline font-black text-sm uppercase tracking-widest mb-8 text-on-surface">Contacto</h4>
            <ul className="space-y-4 text-sm font-black text-on-surface">
          ...
          {/* Admin Access */}
          <div>
            <h4 className="font-headline font-black text-sm uppercase tracking-widest mb-8 text-on-surface">Gestión Interna</h4>
            <Link to="/p2/admin" className="inline-flex items-center gap-3 px-6 py-3 bg-surface-container rounded-2xl border border-on-surface/20 hover:border-primary transition-all group">
